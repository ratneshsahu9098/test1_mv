...
function ForgotPassword() {
  ...
  return (
    <div className="relative w-screen min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-100 via-blue-50 to-indigo-100 dark:bg-[linear-gradient(-45deg,#0f172a,#1e1b4b,#1e3a8a,#3730a3)] dark:bg-[length:400%_400%] dark:animate-[gradient_15s_ease_infinite] overflow-hidden p-4">
